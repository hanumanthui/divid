...
public class PhoneAndContacts extends Fragment {
	Typeface typeface;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startNewActivity(getActivity(), "com.google.android.gm");
		...
		button2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startNewActivity(getActivity(),"com.teamviewer.teamviewer.market.mobile");
		...
		button4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startNewActivity(getActivity(), "com.google.android.dialer");
		...
		button3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startNewActivity(getActivity(), "com.google.android.contacts");
